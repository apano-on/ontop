...
public class OpenEOFilterBboxFunctionSymbolImpl extends AbstractOpenEOFunctionSymbol {

    public OpenEOFilterBboxFunctionSymbolImpl(@Nonnull String functionSymbolName, @Nonnull IRI functionIRI,
