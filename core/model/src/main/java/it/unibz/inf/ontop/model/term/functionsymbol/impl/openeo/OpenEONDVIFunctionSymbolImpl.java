...
public class OpenEONDVIFunctionSymbolImpl extends OpenEOProcessGraphFunctionSymbolImpl {

    private final RDFDatatype xsdStringType;

    public OpenEONDVIFunctionSymbolImpl(@Nonnull String functionSymbolName, @Nonnull IRI functionIRI,
