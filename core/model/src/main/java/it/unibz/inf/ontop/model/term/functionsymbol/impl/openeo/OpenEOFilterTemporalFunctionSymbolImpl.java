...
public class OpenEOFilterTemporalFunctionSymbolImpl extends AbstractOpenEOFunctionSymbol {

    public OpenEOFilterTemporalFunctionSymbolImpl(@Nonnull String functionSymbolName, @Nonnull IRI functionIRI,
