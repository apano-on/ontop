...
public class FunctionSymbolFactoryImpl implements FunctionSymbolFactory {
    ...
    protected ImmutableTable<String, Integer, SPARQLFunctionSymbol> createSPARQLFunctionSymbolTable() {
        ...
        ImmutableSet<SPARQLFunctionSymbol> functionSymbols = ImmutableSet.of(
                ...
                new GeofDefaultUnaryIntegerFunctionSymbolImpl("GEOF_COORDINATEDIMENSION",
                        GEOF.COORDINATEDIMENSION, wktLiteral, xsdInteger, TermFactory::getDBSTCoordinateDimension),
                new GeofDefaultUnaryIntegerFunctionSymbolImpl("GEOF_DIMENSION",
                ...
                new GeofDistanceFunctionSymbolImpl("GEOF_METRICDISTANCE", GEOF.METRICDISTANCE, wktLiteral,
                        xsdDouble, this),
                new GeofGeometryTypeFunctionSymbolImpl(GEOF.GEOMETRYTYPE, wktLiteral, iriType),
                new GeofDefaultUnaryBooleanFunctionSymbolImpl("GEOF_IS_EMPTY", GEOF.ISEMPTY, wktLiteral,
                        xsdBoolean, TermFactory::getDBSTisEmpty),
                new GeofDefaultUnaryBooleanFunctionSymbolImpl("GEOF_IS_SIMPLE", GEOF.ISSIMPLE, wktLiteral,
                        xsdBoolean, TermFactory::getDBSTisSimple),
                new GeofDefaultUnaryBooleanFunctionSymbolImpl("GEOF_IS_3D", GEOF.IS3D, wktLiteral,
                        xsdBoolean, TermFactory::getDBSTis3D),
                new GeofDefaultUnaryBooleanFunctionSymbolImpl("GEOF_IS_MEASURED", GEOF.ISMEASURED, wktLiteral,
                        xsdBoolean, TermFactory::getDBSTisMeasured),
                new GeofSpatialDimensionFunctionSymbolImpl(GEOF.SPATIALDIMENSION, wktLiteral, xsdInteger),
                new GeofTransformFunctionSymbolImpl(GEOF.TRANSFORM, wktLiteral, iriType),
                new GeofGeometryNFunctionSymbolImpl(GEOF.GEOMETRYN, wktLiteral, xsdInteger),
                new GeofPerimeterFunctionSymbolImpl("GEOF_PERIMETER", GEOF.PERIMETER, wktLiteral,
                        iriType, xsdDouble),
                new GeofPerimeterFunctionSymbolImpl("GEOF_METRICPERIMETER", GEOF.METRICPERIMETER,
                        wktLiteral, xsdDouble),
                new GeofAreaFunctionSymbolImpl("GEOF_AREA", GEOF.AREA, wktLiteral, iriType, xsdDouble),
                new GeofAreaFunctionSymbolImpl("GEOF_METRICAREA", GEOF.METRICAREA, wktLiteral, xsdDouble),
                new GeofLengthFunctionSymbolImpl("GEOF_LENGTH", GEOF.LENGTH, wktLiteral, iriType, xsdDouble),
                new GeofLengthFunctionSymbolImpl("GEOF_METRICLENGTH", GEOF.METRICLENGTH, wktLiteral, xsdDouble),
                //TODO: Unnecessary, keep just the DefaultNumericUnaryFunctionSymbolImpl
                new GeofDefaultUnaryDoubleFunctionSymbolImpl("GEOF_MINX", GEOF.MINX, wktLiteral, xsdDouble,
                        TermFactory::getDBSTMinX),
                new GeofDefaultUnaryDoubleFunctionSymbolImpl("GEOF_MAXX", GEOF.MAXX, wktLiteral, xsdDouble,
                        TermFactory::getDBSTMaxX),
                new GeofDefaultUnaryDoubleFunctionSymbolImpl("GEOF_MINY", GEOF.MINY, wktLiteral, xsdDouble,
                        TermFactory::getDBSTMinY),
                new GeofDefaultUnaryDoubleFunctionSymbolImpl("GEOF_MAXY", GEOF.MAXY, wktLiteral, xsdDouble,
                        TermFactory::getDBSTMaxY),
                new GeofDefaultUnaryDoubleFunctionSymbolImpl("GEOF_MINZ", GEOF.MINZ, wktLiteral, xsdDouble,
                        TermFactory::getDBSTMinZ),
                new GeofDefaultUnaryDoubleFunctionSymbolImpl("GEOF_MAXZ", GEOF.MAXZ, wktLiteral, xsdDouble,
                        TermFactory::getDBSTMaxZ),
                new GeofDefaultUnaryIntegerFunctionSymbolImpl("GEOF_NUMGEOMETRIES", GEOF.NUMGEOMETRIES,
                        wktLiteral, xsdInteger, TermFactory::getDBSTNumGeometries),
                new GeofDefaultAggFunctionSymbolImpl("GEOF_AGG_BOUNDINGBOX", GEOF.AGGBOUNDINGBOX,
                        wktLiteral, TermFactory::getDBSTAggBoundingBox),
                new GeofDefaultAggFunctionSymbolImpl("GEOF_AGG_BOUNDINGCIRCLE", GEOF.AGGBOUNDINGCIRCLE,
                        wktLiteral, TermFactory::getDBSTAggBoundingCircle),
                new GeofDefaultAggFunctionSymbolImpl("GEOF_AGG_CENTROID", GEOF.AGGCENTROID, wktLiteral,
                        TermFactory::getDBSTAggCentroid),
                new GeofDefaultAggFunctionSymbolImpl("GEOF_AGG_CONCAVEHULL", GEOF.AGGCONCAVEHULL,
                        wktLiteral, TermFactory::getDBSTAggConcaveHull),
                new GeofDefaultAggFunctionSymbolImpl("GEOF_AGG_CONVEXHULL", GEOF.AGGCONVEXHULL,
                        wktLiteral, TermFactory::getDBSTAggConvexHull),
                new GeofDefaultAggFunctionSymbolImpl("GEOF_AGG_UNION", GEOF.AGGUNION, wktLiteral,
                        TermFactory::getDBSTAggUnion),
