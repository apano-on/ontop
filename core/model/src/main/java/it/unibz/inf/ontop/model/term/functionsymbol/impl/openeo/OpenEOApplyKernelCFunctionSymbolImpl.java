...
public class OpenEOApplyKernelCFunctionSymbolImpl extends AbstractOpenEOFunctionSymbol {

    public OpenEOApplyKernelCFunctionSymbolImpl(@Nonnull String functionSymbolName, @Nonnull IRI functionIRI,
