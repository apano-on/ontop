...
public class OpenEOCubeMathFunctionSymbolImpl extends AbstractOpenEOFunctionSymbol {

    public OpenEOCubeMathFunctionSymbolImpl(@Nonnull String functionSymbolName, @Nonnull IRI functionIRI,
