...
public class OpenEOSarBackscatterFunctionSymbolImpl extends AbstractOpenEOFunctionSymbol {

    public OpenEOSarBackscatterFunctionSymbolImpl(@Nonnull String functionSymbolName, @Nonnull IRI functionIRI,
