...
public class OpenEOFilterBandsFunctionSymbolImpl extends AbstractOpenEOFunctionSymbol {

    public OpenEOFilterBandsFunctionSymbolImpl(@Nonnull String functionSymbolName, @Nonnull IRI functionIRI,
