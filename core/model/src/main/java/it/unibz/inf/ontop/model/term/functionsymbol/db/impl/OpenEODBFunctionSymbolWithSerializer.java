...
public class OpenEODBFunctionSymbolWithSerializer extends AbstractTypedDBFunctionSymbol {
    private final boolean isAlwaysInjective;
    private final DBFunctionSymbolSerializer serializer;

    protected OpenEODBFunctionSymbolWithSerializer(String name, ImmutableList<TermType> inputDBTypes,
