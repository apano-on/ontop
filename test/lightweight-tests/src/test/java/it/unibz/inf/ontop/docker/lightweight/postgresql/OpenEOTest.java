...
public class OpenEOTest extends AbstractDockerRDF4JTest {
    ...
    public void getOpenEOWildfire() {
        ...
        String query = "PREFIX :\t<http://www.unibz-openeo.org#>\n"
                ...
                + "BIND (openeo:load_collection(?satellite, ?xWkt, ?start_time, ?end_time, ?band1, \"max_cloud_cover=90\") AS ?coll1) .\n"
                + "BIND (openeo:load_collection(?satellite, ?xWkt, ?start_time, ?end_time, ?band2, \"max_cloud_cover=90\") AS ?coll2) .\n"
