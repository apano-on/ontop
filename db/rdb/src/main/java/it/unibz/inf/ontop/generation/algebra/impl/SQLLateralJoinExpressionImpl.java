...
import it.unibz.inf.ontop.generation.algebra.SQLLateralJoinExpression;
import it.unibz.inf.ontop.generation.algebra.SQLRelationVisitor;
import it.unibz.inf.ontop.model.term.ImmutableExpression;

import java.util.Optional;

public class SQLLateralJoinExpressionImpl implements SQLLateralJoinExpression {
    ...
    @AssistedInject
    private SQLLateralJoinExpressionImpl(@Assisted("leftExpression") SQLExpression leftExpression,
